...
public class ReportKit360 {
    ...
    public  String createPDF(String templatePath,Object data, String fileName){
        ...
        try {
            ...
            kit.setSaveFilePath("E:/guizhouproject/pdf/wl.pdf");
    ...
    /*public static void main(String[] args) {
        ...
        templateBO.setImageUrl("E:/guizhouproject/pdf/qs.png");
...
public static void main(String[] args) {
	 ReportKit360 kit=new ReportKit360();
     TemplateBO templateBO=new TemplateBO();
	 templateBO.setTemplateName("签章Demo");
	 templateBO.setITEXTUrl("王亮");
     templateBO.setFreeMarkerUrl("2018-05-01");
     templateBO.setJFreeChartUrl("贵州农信");
     templateBO.setImageUrl("E:/guizhouproject/pdf/qs.png");
     String templatePath="/Users/fgm/workspaces/fix/pdf-kit/src/test/resources/templates";
     //String templatePath="/Users";
     String path= kit.createPDF(templatePath,templateBO,"qianzhang.pdf");
     System.out.println(path);
}
